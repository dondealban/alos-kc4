...
Export.image.toDrive({
  ...
  description: 'Classification_Sibuyan_2007_L4',
...
Export.image.toDrive({
  ...
  description: 'Classification_Sibuyan_2010_L4',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.image.toDrive({
  ...
  description: 'Classification_Sibuyan_2015_L4',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.table.toDrive(roi2007train, 'ROI_Train_Sibuyan_2007_L4', 'Google Earth Engine');
Export.table.toDrive(roi2010train, 'ROI_Train_Sibuyan_2010_L4', 'Google Earth Engine');
Export.table.toDrive(roi2015train, 'ROI_Train_Sibuyan_2015_L4', 'Google Earth Engine');
Export.table.toDrive(roi2007test, 'ROI_Test_Sibuyan_2007_L4', 'Google Earth Engine');
Export.table.toDrive(roi2010test, 'ROI_Test_Sibuyan_2010_L4', 'Google Earth Engine');
Export.table.toDrive(roi2015test, 'ROI_Test_Sibuyan_2015_L4', 'Google Earth Engine');
Export.table.toDrive(validation2007, 'Validation_Sibuyan_2007_L4', 'Google Earth Engine');
Export.table.toDrive(validation2010, 'Validation_Sibuyan_2010_L4', 'Google Earth Engine');
Export.table.toDrive(validation2015, 'Validation_Sibuyan_2015_L4', 'Google Earth Engine');
...
Export.table.toDrive({
  ...
  description: 'AA_Sibuyan_2007_L4',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_Sibuyan_2010_L4',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_Sibuyan_2015_L4',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
