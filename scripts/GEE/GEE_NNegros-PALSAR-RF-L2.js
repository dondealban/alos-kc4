/*
 * This script sets up ALOS/PALSAR-1 and ALOS/PALSAR-2 images over Nothern Negros Island 
 * Province, Philippines at three time points for the years 2007, 2010, and 2015. The SAR 
 * images were classified at Level 2 of a multi-level, hierarchical classification system
 * with 5 classes namely: Forestland, Settlements, Cropland, Wetland, Grassland.
 */
...
Export.image.toDrive({
  ...
  description: 'Classification_NNegros_2007_L2',
...
Export.image.toDrive({
  ...
  description: 'Classification_NNegros_2010_L2',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.image.toDrive({
  ...
  description: 'Classification_NNegros_2015_L2',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.table.toDrive(roi2007train, 'ROI_Train_NNegros_2007_L2', 'Google Earth Engine');
Export.table.toDrive(roi2010train, 'ROI_Train_NNegros_2010_L2', 'Google Earth Engine');
Export.table.toDrive(roi2015train, 'ROI_Train_NNegros_2015_L2', 'Google Earth Engine');
Export.table.toDrive(roi2007test, 'ROI_Test_NNegros_2007_L2', 'Google Earth Engine');
Export.table.toDrive(roi2010test, 'ROI_Test_NNegros_2010_L2', 'Google Earth Engine');
Export.table.toDrive(roi2015test, 'ROI_Test_NNegros_2015_L2', 'Google Earth Engine');
Export.table.toDrive(validation2007, 'Validation_NNegros_2007_L2', 'Google Earth Engine');
Export.table.toDrive(validation2010, 'Validation_NNegros_2010_L2', 'Google Earth Engine');
Export.table.toDrive(validation2015, 'Validation_NNegros_2015_L2', 'Google Earth Engine');
...
Export.table.toDrive({
  ...
  description: 'AA_NNegros_2007_L2',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_NNegros_2010_L2',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_NNegros_2015_L2',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
