...
roi2007 <- read.csv(file="ROI_Sibuyan_2007_L1.csv", header=TRUE, sep=",")
roi2010 <- read.csv(file="ROI_Sibuyan_2010_L1.csv", header=TRUE, sep=",")
roi2015 <- read.csv(file="ROI_Sibuyan_2015_L1.csv", header=TRUE, sep=",")
