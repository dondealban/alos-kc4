...
train2007 <- read.csv(file="ROI_Train_NNegros_2007_L4.csv", header=TRUE, sep=",")
test2007 <- read.csv(file="ROI_Test_NNegros_2007_L4.csv", header=TRUE, sep=",")
train2010 <- read.csv(file="ROI_Train_NNegros_2010_L4.csv", header=TRUE, sep=",")
test2010 <- read.csv(file="ROI_Test_NNegros_2010_L4.csv", header=TRUE, sep=",")
train2015 <- read.csv(file="ROI_Train_NNegros_2015_L4.csv", header=TRUE, sep=",")
test2015 <- read.csv(file="ROI_Test_NNegros_2015_L4.csv", header=TRUE, sep=",")
...
# 3. Add new Type column with land cover type string based on Code values
  lookup <- c("CFB","OFB","MGF","BUA","CAC","CPC","ILW","OGL","OSH","OWG")
