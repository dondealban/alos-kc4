...
Export.table.toDrive(roi2007, 'ROI_Sibuyan_2007_L3', 'Google Earth Engine');\
Export.table.toDrive(roi2010, 'ROI_Sibuyan_2010_L3', 'Google Earth Engine');\
Export.table.toDrive(roi2015, 'ROI_Sibuyan_2015_L3', 'Google Earth Engine');\
Export.table.toDrive(train2007, 'Training_Sibuyan_2007_L3', 'Google Earth Engine');\
Export.table.toDrive(train2010, 'Training_Sibuyan_2010_L3', 'Google Earth Engine');\
Export.table.toDrive(train2015, 'Training_Sibuyan_2015_L3', 'Google Earth Engine');\
