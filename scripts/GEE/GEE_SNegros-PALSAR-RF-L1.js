 ...
 * classified at Level 1 of a multi-level, hierarchical classification system with 2 classes 
 * namely: Forest, Non-Forest.
 */
...
Export.image.toDrive({
  ...
  description: 'Classification_SNegros_2007_L1',
...
Export.image.toDrive({
  ...
  description: 'Classification_SNegros_2010_L1',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.image.toDrive({
  ...
  description: 'Classification_SNegros_2015_L1',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.table.toDrive(roi2007train, 'ROI_Train_SNegros_2007_L1', 'Google Earth Engine');
Export.table.toDrive(roi2010train, 'ROI_Train_SNegros_2010_L1', 'Google Earth Engine');
Export.table.toDrive(roi2015train, 'ROI_Train_SNegros_2015_L1', 'Google Earth Engine');
Export.table.toDrive(roi2007test, 'ROI_Test_SNegros_2007_L1', 'Google Earth Engine');
Export.table.toDrive(roi2010test, 'ROI_Test_SNegros_2010_L1', 'Google Earth Engine');
Export.table.toDrive(roi2015test, 'ROI_Test_SNegros_2015_L1', 'Google Earth Engine');
Export.table.toDrive(validation2007, 'Validation_SNegros_2007_L1', 'Google Earth Engine');
Export.table.toDrive(validation2010, 'Validation_SNegros_2010_L1', 'Google Earth Engine');
Export.table.toDrive(validation2015, 'Validation_SNegros_2015_L1', 'Google Earth Engine');
...
Export.table.toDrive({
  ...
  description: 'AA_SNegros_2007_L1',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_SNegros_2010_L1',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_SNegros_2015_L1',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
