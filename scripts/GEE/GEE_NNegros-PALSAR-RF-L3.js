 ...
 * images were classified at Level 3 of a multi-level, hierarchical classification system
 * with 10 classes namely: Closed Forest, Open Forest, Mangrove Forest, Built-up, Annual
 * Crop, Perennial Crop, Inland Water, Grassland, Shrubs, Wooded Grassland.
 */
...
var em2007 = validation2007.errorMatrix('ClassID3', 'classification'); // Error matrix
...
// Calculate accuracy metrics
var em2010 = validation2010.errorMatrix('ClassID3', 'classification'); // Error matrix
...
// Calculate accuracy metrics
var em2015 = validation2015.errorMatrix('ClassID3', 'classification'); // Error matrix
...
var classPalette = ['ffffff',  // No data
                    '246a24',  // Closed forest
                    'ccff66',  // Open forest
                    '6666ff',  // Mangrove forest
                    'ff0000',  // Built-up
                    '966400',  // Annual crop
                    '784b00',  // Perennial crop
                    'fb9a99',  // Fishpond
                    '66ccff',  // Inland water
                    'ffff66',  // Grassland
                    'cfcfcf',  // Fallow
                    'ffd278',  // Shrub
                    'ffb432']; // Wooded grassland
Map.addLayer(masked2007, {min: 0, max: 12, palette: classPalette}, '2007 Classification',  true);
Map.addLayer(masked2010, {min: 0, max: 12, palette: classPalette}, '2010 Classification',  true);
Map.addLayer(masked2015, {min: 0, max: 12, palette: classPalette}, '2015 Classification',  true);
...
Export.image.toDrive({
  ...
  description: 'Classification_NNegros_2007_L3',
...
Export.image.toDrive({
  ...
  description: 'Classification_NNegros_2010_L3',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.image.toDrive({
  ...
  description: 'Classification_NNegros_2015_L3',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.table.toDrive(roi2007train, 'ROI_Train_NNegros_2007_L3', 'Google Earth Engine');
Export.table.toDrive(roi2010train, 'ROI_Train_NNegros_2010_L3', 'Google Earth Engine');
Export.table.toDrive(roi2015train, 'ROI_Train_NNegros_2015_L3', 'Google Earth Engine');
Export.table.toDrive(roi2007test, 'ROI_Test_NNegros_2007_L3', 'Google Earth Engine');
Export.table.toDrive(roi2010test, 'ROI_Test_NNegros_2010_L3', 'Google Earth Engine');
Export.table.toDrive(roi2015test, 'ROI_Test_NNegros_2015_L3', 'Google Earth Engine');
Export.table.toDrive(validation2007, 'Validation_NNegros_2007_L3', 'Google Earth Engine');
Export.table.toDrive(validation2010, 'Validation_NNegros_2010_L3', 'Google Earth Engine');
Export.table.toDrive(validation2015, 'Validation_NNegros_2015_L3', 'Google Earth Engine');
...
Export.table.toDrive({
  ...
  description: 'AA_NNegros_2007_L3',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_NNegros_2010_L3',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_NNegros_2015_L3',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
