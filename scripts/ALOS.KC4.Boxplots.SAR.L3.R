...
train2007 <- read.csv(file="ROI_Train_Sibuyan_2007_L3.csv", header=TRUE, sep=",")
test2007 <- read.csv(file="ROI_Test_Sibuyan_2007_L3.csv", header=TRUE, sep=",")
train2010 <- read.csv(file="ROI_Train_Sibuyan_2010_L3.csv", header=TRUE, sep=",")
test2010 <- read.csv(file="ROI_Test_Sibuyan_2010_L3.csv", header=TRUE, sep=",")
train2015 <- read.csv(file="ROI_Train_Sibuyan_2015_L3.csv", header=TRUE, sep=",")
test2015 <- read.csv(file="ROI_Test_Sibuyan_2015_L3.csv", header=TRUE, sep=",")
