...
Export.image.toDrive({
  ...
  description: 'Classification_Sibuyan_2007_L2',
...
Export.image.toDrive({
  ...
  description: 'Classification_Sibuyan_2010_L2',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.image.toDrive({
  ...
  description: 'Classification_Sibuyan_2015_L2',
  folder: 'Google Earth Engine',
  region: box,
  scale: 25,
  maxPixels: 300000000,
...
Export.table.toDrive({
  ...
  description: 'AA_Sibuyan_2007_L2',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_Sibuyan_2010_L2',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
...
Export.table.toDrive({
  ...
  description: 'AA_Sibuyan_2015_L2',
  fileFormat: 'CSV',
  folder: 'Google Earth Engine',
});
