...
train2007 <- read.csv(file="ROI_Train_SNegros_2007_L2.csv", header=TRUE, sep=",")
test2007 <- read.csv(file="ROI_Test_SNegros_2007_L2.csv", header=TRUE, sep=",")
train2010 <- read.csv(file="ROI_Train_SNegros_2010_L2.csv", header=TRUE, sep=",")
test2010 <- read.csv(file="ROI_Test_SNegros_2010_L2.csv", header=TRUE, sep=",")
train2015 <- read.csv(file="ROI_Train_SNegros_2015_L2.csv", header=TRUE, sep=",")
test2015 <- read.csv(file="ROI_Test_SNegros_2015_L2.csv", header=TRUE, sep=",")
